...
*/
(function(d){var g=function(e,c){var f={options:e,$root:c,data:null,view:null};f.options=$.extend({submitUrl:function(a){return"#"+a},dataSource:"",dataArray:[],oneFile:"",server:function(a){return{url:"server.php?val="+a,dataType:"json",type:"GET",cache:!1}},minChars:1,maxItems:5,matchCase:!1,matchFromStart:!1,filterBy:["title","desc"],templatePath:"#jautocompleteTemplate",onSuggest:function(a){},onSelect:function(a,c,d){},dataReadyEvent:"dataReadyEvent",getDataEvent:"getDataEvent",
